...
import { Input, Button, IconButton, Badge, Box, Paper, Typography } from "@material-ui/core";
...
export default function MediaPipe() {
    ...
    const copyUrl = () => {
        ...
        if (!navigator.clipboard){
            ...
            } catch(err){ alertmessage.error("Failed to copy")}
    ...
    function onResults(results){
        ...
        mediapipeland(canvasCtx, results.poseLandmarks, { color: "#FF0000", lineWidth: 2 })
        mediapipeconnect(canvasCtx, results.faceLandmarks, holis.FACEMESH_TESSELATION, {
            color: "#C0C0C070",
            lineWidth: 1,
        });
        mediapipeconnect(canvasCtx, results.leftHandLandmarks, holis.HAND_CONNECTIONS, {
            color: "#CC0000",
            lineWidth: 5,
        });
        ...
        mediapipeconnect(canvasCtx, results.rightHandLandmarks, holis.HAND_CONNECTIONS, {
            color: "#00CC00",
            lineWidth: 5,
        });
        ...
        <div>
            {askForUsername === true ? (
                <div>
                    ...
                    <div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
                        <canvas id="my-canvas" ref={canvasRef} style={{
                            borderStyle: "solid",borderColor: "#bdbdbd",objectFit: "fill",width: "60%",height: "30%"}}></canvas>
                    </div>
                </div>
            ) : (
                <div>
